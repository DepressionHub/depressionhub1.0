...
-- DropForeignKey
ALTER TABLE "TherapySession" DROP CONSTRAINT "TherapySession_userId_fkey";
...
-- AlterTable
ALTER TABLE "Therapist" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "TherapySession" ALTER COLUMN "userId" SET DATA TYPE TEXT;
