...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      "DepressionHub is built for everyone. Decentralized Social network should be easy-to-use and convenient while offering people interact to therpist  for better health  on our encrypted network.",
  },
});
